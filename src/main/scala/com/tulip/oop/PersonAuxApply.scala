...
object PersonAuxApply {
  def main(args: Array[String]): Unit = {
    ...
    println(Person3("Buck Trends1")) // 主
    // 结果: Person3(Buck Trends1,None,None)
    println(Person3("Buck Trends2", Some(20), Some(a1))) // 主
